...
// define interface for common vehicle properties
interface Vehicle {
  vin: string;
  make: string;
  model: string;
...
class Cli {
  vehicles: Vehicle[];
  exit: boolean = false;
  selectedVehicleVin: string = ""; // Added missing property
  ...
  createMotorbike(): void {
    inquirer
      ...
      .then((answers) => {
        ...
        // Create a new motorbike with the user's input
      ...
      .prompt([
        {
          ...
          choices: (selectedVehicle => {
            ...
            if (selectedVehicle instanceof Truck) {
              baseChoices.splice(8, 0, 'Tow a vehicle');
            }

            if (selectedVehicle instanceof Motorbike) {
              baseChoices.splice(8, 0, 'Do a wheelie');
            }

            return baseChoices;
          })(this.vehicles.find(vehicle => vehicle.vin === this.selectedVehicleVin)),
        },
      ])
